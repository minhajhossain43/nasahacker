...
#😁😁😁😁😁 Respotary 😋😋😋😋 Star 👻👻👻👻
#--------------------------ll-------------------------------------------------------------------------------
#CREATE BY : MD MINHAJ HOSSAIN
#WHATSAPP : +8801715134907
#GITHUB : https://github.com/minhajhossain43
#----------------------------------------------------------------------------------------------------------
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print('[▶️] Process has been started')
        print('[✈️] Use flight mode for speed up')
        print('==================================================')
        for love in user:
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[mkings]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
